...
- You may ONLY answer questions directly pertaining to:
  ...
  * His flagship architecture projects:
    ...
    8. Versant Practice Test Simulator — a realistic mock Versant speaking and listening test simulator built with React 19, TypeScript, and Google Gemini AI featuring real-time speech recognition, text-to-speech audio, automated GSE & CEFR scoring (10-90 scale), adaptive timers, and diagnostic feedback across Parts A-F.
    9. ResolveAI — an intelligent IT service desk agent and 15-node LangGraph state machine powered by Google Gemini, ChromaDB vector RAG, simulated diagnostic tools (VPN, email, account, device health), dynamic confidence scoring, and human-in-the-loop approval pauses (interrupt_before) running on safe synthetic enterprise data.
...
- Sonu's primary projects are:
  ...
  8. Versant Practice Test Simulator: A realistic speaking & listening exam simulator built with React 19, TypeScript, and Google Gemini AI. Features real-time speech recognition, text-to-speech audio delivery, automated GSE & CEFR scoring (10-90 scale), adaptive timers, word-by-word diff comparisons, and print-ready PDF scorecards across test sections Parts A-F. (Public GitHub Repository: https://github.com/Sonu-Thomas-001/Versant-Practice-Test)
  9. ResolveAI: An intelligent IT service desk assistant built as a proof-of-concept with FastAPI, LangGraph (15-node state machine), and ChromaDB vector RAG. Automates incident triage, executes mock diagnostic tools (VPN, email, account, device health), computes confidence scores, and halts for human-in-the-loop approvals before ticket creation on 100% synthetic enterprise data. (Public GitHub Repository: https://github.com/Sonu-Thomas-001/IT-Service-Desk-Agent)
  Treat these as his flagship enterprise systems architectures. You may share the public GitHub repositories for TicketWave, SmartDesk AI, QubiMind, Multi-Agent Enterprise AI Assistant, Versant Practice Test Simulator, and ResolveAI when asked, but do not mention or fabricate any GitHub links for the other projects.
  ...
  return (
    <>
      ...
      <motion.button
        ...
        aria-label="Ask Qubi"
        className={`fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-40 p-2.5 sm:px-3.5 sm:py-2 rounded-full bg-[#161311]/90 backdrop-blur-xl border border-white/10 hover:border-copper/50 text-[#EDE5DC] shadow-xl hover:shadow-glow-copper flex items-center gap-2.5 cursor-pointer group transition-all duration-300 ${
          isOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'
        }`}
      >
        <div className="w-6 h-6 rounded-lg bg-copper/15 text-copper border border-copper/30 flex items-center justify-center group-hover:scale-105 group-hover:bg-copper group-hover:text-white transition-all shrink-0">
