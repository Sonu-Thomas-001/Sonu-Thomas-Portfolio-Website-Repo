    ...
    <section id="projects" className="py-24 sm:py-36 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto border-t border-slate-200/80">
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-slate-950/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <span className="px-4 py-2 rounded-full bg-white/95 backdrop-blur-sm text-xs font-semibold text-slate-900 shadow-soft-sm">
                      View Project Case
                    </span>
                  </div>
      ...
      {isHomepage && (
        <div className="mt-16 text-center">
          <Link
            to="/projects"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-slate-900 text-white text-sm font-medium hover:bg-primary transition-all duration-300 shadow-soft-sm group"
          >
